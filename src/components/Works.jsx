    ...
    <div className="p-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex flex-col gap-2">
          <img src="work1.png" className="w-full rounded-3xl mb-4" alt="" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-4">
            <img src="work2.png" className="w-full rounded-3xl" alt="" />
            <p>App Design - June 20, 2022</p>
          ...
          <div className="flex flex-col gap-4">
            <img src="work3.png" className="w-full rounded-3xl" alt="" />
            <p>App Design - June 20, 2022</p>
            <h3 className="text-2xl font-bold">
          ...
          <div className="flex flex-col gap-4">
            <img src="work4.png" className="w-full rounded-3xl" alt="" />
            <p>App Design - June 20, 2022</p>
            <h3 className="text-2xl font-bold">
          ...
          <div className="flex flex-col gap-4">
            <img src="work5.png" className="w-full rounded-3xl" alt="" />
            <p>App Design - June 20, 2022</p>
            <h3 className="text-2xl font-bold">
